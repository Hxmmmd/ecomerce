            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-full left-0 right-0 mt-2 bg-black/60 backdrop-blur-md supports-[backdrop-filter]:bg-black/30 border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-50 p-2"
                    >
                        {results.length > 0 ? (
