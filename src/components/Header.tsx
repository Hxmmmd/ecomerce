            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex h-16 items-center justify-start gap-8">
                    ...
                    <div className="flex items-center ml-auto space-x-2">
                        {status === 'authenticated' && !isAdmin && (
                            <>
                                <Link href="/orders" className={cn(buttonVariants('ghost', 'icon'), 'text-gray-400 hover:text-white')}>
                                    <Package className="h-5 w-5" />
                                </Link>
                                <Link href="/cart" className={cn(buttonVariants('ghost', 'icon'), 'relative text-gray-400 hover:text-white')}>
